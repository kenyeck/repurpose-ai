         ...
         <div className="max-w-5xl mx-auto px-6 py-16">
            ...
            <div className="text-center mb-16">
               ...
               <h1 className="text-6xl font-semibold tracking-tight mb-6">
                  How Generator AI Works
               </h1>
               <p className="text-2xl text-zinc-400 max-w-2xl mx-auto">
                  From one piece of content to a full multi-platform content strategy — powered by
            ...
            <div className="space-y-24">
               ...
               <div className="grid md:grid-cols-2 gap-12 items-center">
                  <div>
                     <div className="text-emerald-400 text-sm font-medium tracking-widest mb-3">
                        STEP 01
                     </div>
                     <h2 className="text-4xl font-semibold mb-6">Paste Your Content</h2>
                     <p className="text-zinc-400 text-lg leading-relaxed">
                        Simply copy and paste any long-form content — blog posts, YouTube
                        transcripts, podcast episodes, LinkedIn drafts, meeting notes, or even raw
                        ideas.
                     </p>
               ...
               <div className="grid md:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="flex gap-6">
                           ...
                           <div>
                              ...
                              <p className="text-zinc-400">
                                 Extracts core message, tone, key takeaways, and viral hooks
                              </p>
                           </div>
                        </div>
                        <div className="flex gap-6">
                           ...
                           <div>
                              <h4 className="font-medium text-lg mb-1">Platform Generator Agent</h4>
                              <p className="text-zinc-400">
                                 Transforms content into native formats for Twitter, LinkedIn,
                                 Instagram, YouTube Shorts, newsletters, and more
                              </p>
                           </div>
                        </div>
                        <div className="flex gap-6">
                           ...
                           <div>
                              ...
                              <p className="text-zinc-400">
                                 Suggests best posting times, A/B variations, and engagement
                                 predictions
                              </p>
                           </div>
                        </div>
                  ...
                  <div className="md:order-1 bg-zinc-900 rounded-3xl p-10">
                     ...
                     <p className="text-zinc-400 leading-relaxed">
                        The agents work together sequentially with shared memory. This produces far
                        more consistent and higher-quality results than single-prompt AI tools.
                     </p>
                  </div>
               </div>
               ...
               <div className="text-center">
                  ...
                  <p className="text-zinc-400 max-w-xl mx-auto text-lg mb-12">
                     In under a minute, you receive a complete set of professionally formatted
